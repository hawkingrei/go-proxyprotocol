...
func (c *proxyProtocolConn) extraceClientIPV2(buffer []byte, connRemoteAddr net.Addr) (net.Addr, error) {
	...
	case 0x01: /* PROXY command */
		...
		case 0x11: /* TCPv4 */
			...
			log.Info("proxyprotocol origin ip/port", zap.Any("dstip", originAddrV4), zap.Uint16("dstport", originPortV4),
				zap.Any("srcAddrV4", srcAddrV4), zap.Uint16("srcPortV4", srcPortV4))
			return &net.TCPAddr{
				IP:   srcAddrV4,
				Port: int(srcPortV4),
			}, nil
